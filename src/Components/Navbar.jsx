...
<nav className="shadow-[-3px_12px_8px_-4px_rgba(0,0,0,0.48)] bg-[#d9d9d9] px-2 sm:px-4 py-2.5 fixed w-full z-40 top-0 left-0">
  ...
  <div className="linksDiv items-center justify-between w-full">
    <ul className="flex p-4 flex-row mediumScreen space-x-8 mt-0 text-sm font-medium border-0">
      <li>
        <a href="#" className="block py-2 pl-3 pr-4 text-black rounded-lg border-b-4 border-transparent hover:bg-gray-100 hover:border-b-4 hover:border-[#fadccc] hover:text-red-800 focus:border-b-4 focus:border-[#b85118]" aria-current="page">Home</a>
      </li>
      <li>
